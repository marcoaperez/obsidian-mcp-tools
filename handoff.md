...
### Pending immediate post-session (al 2026-05-13 mid-day)

- **PR #95 lockfile fix** atteso da marcoaperez — single-commit `bun install` + `git add bun.lock` + amend/force-push. Pattern historic suggerisce <24h turnaround. Quando CI green, squash-merge con subject `feat(0.4): get_recent_files review follow-ups (#95)` + Author preserved.
